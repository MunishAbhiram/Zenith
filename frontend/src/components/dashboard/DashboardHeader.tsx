  ...
  return (
    <header className="flex justify-between items-center mb-16 relative z-10 w-full">
      ...
      <div className="flex items-center">
        ...
        <span className="font-logo font-bold text-3xl md:text-3xl tracking-tight text-[#005840] mt-1">
          Zenith
        </span>
      </div>
      
      {/* Middle: Navigation Buttons (Perfectly Centered) */}
      <div className="hidden md:flex gap-3 absolute left-1/2 transform -translate-x-1/2">
      ...
      {/* Right: User Profile */}
      <div className="bg-white rounded-full px-4 py-2 flex items-center gap-3 shadow-sm z-10">
